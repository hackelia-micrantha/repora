...
- CI-environment posture v2 adds YAML-aware bounded host-tool invocation and explicit setup-action signals while preserving strict v1 convergence compatibility and unknown/unavailable evidence semantics.
