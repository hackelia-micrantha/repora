...
Do not infer atomic multi-remote transactions, rollback, arbitrary-ref support, or hosted-control-plane behavior from this summary. Those capabilities are outside the current implemented architecture unless a canonical source explicitly says otherwise.
