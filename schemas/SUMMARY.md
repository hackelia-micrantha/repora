...
- `posture-storage-v1.schema.json`
...
- `posture-policy-profile-v2.schema.json`
- `posture-policy-inputs-v1.schema.json`
- `posture-report-v1.schema.json`
- `posture-report-v2.schema.json`
